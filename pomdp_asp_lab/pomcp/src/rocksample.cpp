...
void ROCKSAMPLE::GenerateFromRules15_20(const STATE& state, const BELIEF_STATE &belief,
...
void ROCKSAMPLE::GenerateFromRules15_40(const STATE& state, const BELIEF_STATE &belief,
    vector<int>& actions, const STATUS& status) const
{
    // cout << "USING HARDCODED 15" << endl;
    // cout << "USING HARDCODED RULES" << endl;
...
void ROCKSAMPLE::GenerateFromRules15_60(const STATE& state, const BELIEF_STATE &belief,
    vector<int>& actions, const STATUS& status) const
{
    // cout << "USING HARDCODED 15" << endl;
    // cout << "USING HARDCODED RULES" << endl;
...
void ROCKSAMPLE::GenerateFromRules15(const STATE& state, const BELIEF_STATE &belief,
    vector<int>& actions, const STATUS& status) const
{
    // cout << "USING HARDCODED 15" << endl;
    // cout << "USING HARDCODED RULES" << endl;
...
void ROCKSAMPLE::GenerateFromRules11(const STATE& state, const BELIEF_STATE &belief,
    vector<int>& actions, const STATUS& status) const
{
